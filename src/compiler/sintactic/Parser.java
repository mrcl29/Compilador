...
public class Parser extends java_cup.runtime.lr_parser {
    ...
    TaulaSimbols taulaTokens = new TaulaSimbols();
    ...
    public void syntax_error(Symbol s) {
        try {
            ...
            System.err.println("Error sintáctico en la línea: " + fila + " y columna: " + columna
                    + ". No se esperaba el componente: " + lexema);
        } catch (Exception e) {
        }
    }
    ...
    public void unrecovered_syntax_error(Symbol s) throws java.lang.Exception {
        try {
            ...
            System.err.println("Error sintactico inrrecuperable en la linea: " + fila + " y columna: " + columna
                    + ". No se esperaba el componente: " + lexema);
        } catch (Exception e) {
        }
        done_parsing();
        ...
        public final java_cup.runtime.Symbol CUP$Parser$do_action_part00000000(
            ...
            switch (CUP$Parser$act_num) {
                ...
                case 1: // S ::= P
                {
                    ...
                    CUP$Parser$result = parser.getSymbolFactory().newSymbol("S", 0,
                ...
                case 2: // P ::= DECL P
                {
                    ...
                    CUP$Parser$result = parser.getSymbolFactory().newSymbol("P", 1,
                            ((java_cup.runtime.Symbol) CUP$Parser$stack.elementAt(CUP$Parser$top - 1)),
                            ((java_cup.runtime.Symbol) CUP$Parser$stack.peek()), RESULT);
                }
                    return CUP$Parser$result;
                ...
                case 9: // VAR_DECL ::= val id double_colon TIPO assign EXP semicolon
                {
                    ...
                    CUP$Parser$result = parser.getSymbolFactory().newSymbol("VAR_DECL", 3,
                ...
                case 10: // CONS_DECL ::= con id double_colon TIPO assign EXP semicolon
                {
                    ...
                    CUP$Parser$result = parser.getSymbolFactory().newSymbol("CONS_DECL", 4,
                            ((java_cup.runtime.Symbol) CUP$Parser$stack.elementAt(CUP$Parser$top - 6)),
                            ((java_cup.runtime.Symbol) CUP$Parser$stack.peek()), RESULT);
                }
                    return CUP$Parser$result;
                ...
                case 11: // TUPLA_DECL ::= tuple id assign lbrace TIPO comma TIPO rbrace semicolon
                {
                    ...
                    CUP$Parser$result = parser.getSymbolFactory().newSymbol("TUPLA_DECL", 5,
                ...
                /* . . . . . . . . . . . . . . . . . . . . */
                case 12: // FUNC_DECL ::= fnct TIPO id lparen PARAM_LIST rparen colon COS FINAL_RTN
                         // endfnct
                {
                    Object RESULT = null;

                    CUP$Parser$result = parser.getSymbolFactory().newSymbol("FUNC_DECL", 6,
                ...
                case 14: // PARAM_LIST ::= PARAM
                {
                    ...
                    CUP$Parser$result = parser.getSymbolFactory().newSymbol("PARAM_LIST", 7,
                            ((java_cup.runtime.Symbol) CUP$Parser$stack.peek()),
                            ((java_cup.runtime.Symbol) CUP$Parser$stack.peek()), RESULT);
                }
                    return CUP$Parser$result;
                ...
                case 17: // PARAM ::= id double_colon TIPO
                {
                    ...
                    CUP$Parser$result = parser.getSymbolFactory().newSymbol("PARAM", 8,
                            ((java_cup.runtime.Symbol) CUP$Parser$stack.elementAt(CUP$Parser$top - 2)),
                            ((java_cup.runtime.Symbol) CUP$Parser$stack.peek()), RESULT);
                }
                    return CUP$Parser$result;
                ...
                case 18: // COS ::= SENT COS
                {
                    ...
                    CUP$Parser$result = parser.getSymbolFactory().newSymbol("COS", 9,
                            ((java_cup.runtime.Symbol) CUP$Parser$stack.elementAt(CUP$Parser$top - 1)),
                            ((java_cup.runtime.Symbol) CUP$Parser$stack.peek()), RESULT);
                }
                    return CUP$Parser$result;
                ...
                case 20: // FINAL_RTN ::= rtrn lparen EXP rparen semicolon
                {
                    ...
                    CUP$Parser$result = parser.getSymbolFactory().newSymbol("FINAL_RTN", 10,
                ...
                case 21: // SENT ::= ASIG_SENT
                {
                    ...
                    CUP$Parser$result = parser.getSymbolFactory().newSymbol("SENT", 11,
                            ((java_cup.runtime.Symbol) CUP$Parser$stack.peek()),
                            ((java_cup.runtime.Symbol) CUP$Parser$stack.peek()), RESULT);
                }
                    return CUP$Parser$result;
                ...
                case 29: // ASIG_SENT ::= id assign EXP semicolon
                {
                    ...
                    CUP$Parser$result = parser.getSymbolFactory().newSymbol("ASIG_SENT", 12,
                ...
                case 30: // IF_SENT ::= if_t lparen EXP rparen colon COS else_t colon COS endif
                {
                    ...
                    CUP$Parser$result = parser.getSymbolFactory().newSymbol("IF_SENT", 13,
                            ((java_cup.runtime.Symbol) CUP$Parser$stack.elementAt(CUP$Parser$top - 9)),
                            ((java_cup.runtime.Symbol) CUP$Parser$stack.peek()), RESULT);
                }
                    return CUP$Parser$result;
                ...
                case 32: // WHILE_SENT ::= while_t lparen EXP rparen colon COS endwhile
                {
                    ...
                    CUP$Parser$result = parser.getSymbolFactory().newSymbol("WHILE_SENT", 14,
                            ((java_cup.runtime.Symbol) CUP$Parser$stack.elementAt(CUP$Parser$top - 6)),
                            ((java_cup.runtime.Symbol) CUP$Parser$stack.peek()), RESULT);
                }
                    return CUP$Parser$result;
                ...
                case 33: // FOR_SENT ::= for_t FORINIT to FORLIMIT colon COS endfor
                {
                    ...
                    CUP$Parser$result = parser.getSymbolFactory().newSymbol("FOR_SENT", 15,
                            ((java_cup.runtime.Symbol) CUP$Parser$stack.elementAt(CUP$Parser$top - 6)),
                            ((java_cup.runtime.Symbol) CUP$Parser$stack.peek()), RESULT);
                }
                    return CUP$Parser$result;
                ...
                case 34: // FORINIT ::= VAR_DECL
                {
                    ...
                    CUP$Parser$result = parser.getSymbolFactory().newSymbol("FORINIT", 16,
                            ((java_cup.runtime.Symbol) CUP$Parser$stack.peek()),
                            ((java_cup.runtime.Symbol) CUP$Parser$stack.peek()), RESULT);
                }
                    return CUP$Parser$result;
                ...
                case 36: // FORLIMIT ::= CONS_DECL
                {
                    ...
                    CUP$Parser$result = parser.getSymbolFactory().newSymbol("FORLIMIT", 17,
                            ((java_cup.runtime.Symbol) CUP$Parser$stack.peek()),
                            ((java_cup.runtime.Symbol) CUP$Parser$stack.peek()), RESULT);
                }
                    return CUP$Parser$result;
                ...
                case 38: // TUPLA_ASSIGN ::= TUPLA_ACCESS assign EXP semicolon
                {
                    ...
                    CUP$Parser$result = parser.getSymbolFactory().newSymbol("TUPLA_ASSIGN", 18,
                            ((java_cup.runtime.Symbol) CUP$Parser$stack.elementAt(CUP$Parser$top - 3)),
                            ((java_cup.runtime.Symbol) CUP$Parser$stack.peek()), RESULT);
                }
                    return CUP$Parser$result;
                ...
                case 39: // ENTR_SENT ::= in lparen TIPO rparen semicolon
                {
                    ...
                    CUP$Parser$result = parser.getSymbolFactory().newSymbol("ENTR_SENT", 19,
                            ((java_cup.runtime.Symbol) CUP$Parser$stack.elementAt(CUP$Parser$top - 4)),
                            ((java_cup.runtime.Symbol) CUP$Parser$stack.peek()), RESULT);
                }
                    return CUP$Parser$result;
                ...
                case 40: // SAL_SENT ::= out lparen OUT_EXP rparen semicolon
                {
                    ...
                    CUP$Parser$result = parser.getSymbolFactory().newSymbol("SAL_SENT", 20,
                            ((java_cup.runtime.Symbol) CUP$Parser$stack.elementAt(CUP$Parser$top - 4)),
                            ((java_cup.runtime.Symbol) CUP$Parser$stack.peek()), RESULT);
                }
                    return CUP$Parser$result;
                ...
                case 41: // ENTR_FUNC ::= in lparen TIPO rparen
                {
                    ...
                    CUP$Parser$result = parser.getSymbolFactory().newSymbol("ENTR_FUNC", 36,
                            ((java_cup.runtime.Symbol) CUP$Parser$stack.elementAt(CUP$Parser$top - 3)),
                            ((java_cup.runtime.Symbol) CUP$Parser$stack.peek()), RESULT);
                }
                    return CUP$Parser$result;
                ...
                case 42: // SAL_FUNC ::= out lparen OUT_EXP rparen
                {
                    ...
                    CUP$Parser$result = parser.getSymbolFactory().newSymbol("SAL_FUNC", 37,
                            ((java_cup.runtime.Symbol) CUP$Parser$stack.elementAt(CUP$Parser$top - 3)),
                            ((java_cup.runtime.Symbol) CUP$Parser$stack.peek()), RESULT);
                }
                    return CUP$Parser$result;
                ...
                case 43: // OUT_EXP ::= id
                {
                    ...
                    CUP$Parser$result = parser.getSymbolFactory().newSymbol("OUT_EXP", 35,
                            ((java_cup.runtime.Symbol) CUP$Parser$stack.peek()),
                            ((java_cup.runtime.Symbol) CUP$Parser$stack.peek()), RESULT);
                }
                    return CUP$Parser$result;
                ...
                case 47: // CRID_FUNC ::= id lparen ARGS rparen
                {
                    ...
                    CUP$Parser$result = parser.getSymbolFactory().newSymbol("CRID_FUNC", 21,
                            ((java_cup.runtime.Symbol) CUP$Parser$stack.elementAt(CUP$Parser$top - 3)),
                            ((java_cup.runtime.Symbol) CUP$Parser$stack.peek()), RESULT);
                }
                    return CUP$Parser$result;
                ...
                case 49: // ARGS ::= EXP ARGS_LIST
                {
                    ...
                    CUP$Parser$result = parser.getSymbolFactory().newSymbol("ARGS", 22,
                            ((java_cup.runtime.Symbol) CUP$Parser$stack.elementAt(CUP$Parser$top - 1)),
                            ((java_cup.runtime.Symbol) CUP$Parser$stack.peek()), RESULT);
                }
                    return CUP$Parser$result;
                ...
                case 50: // ARGS_LIST ::= comma EXP ARGS_LIST
                {
                    ...
                    CUP$Parser$result = parser.getSymbolFactory().newSymbol("ARGS_LIST", 23,
                            ((java_cup.runtime.Symbol) CUP$Parser$stack.elementAt(CUP$Parser$top - 2)),
                            ((java_cup.runtime.Symbol) CUP$Parser$stack.peek()), RESULT);
                }
                    return CUP$Parser$result;
                ...
                case 52: // TIPO ::= integer
                {
                    ...
                    CUP$Parser$result = parser.getSymbolFactory().newSymbol("TIPO", 24,
                            ((java_cup.runtime.Symbol) CUP$Parser$stack.peek()),
                            ((java_cup.runtime.Symbol) CUP$Parser$stack.peek()), RESULT);
                }
                    return CUP$Parser$result;
                ...
                case 54: // EXP ::= LOG_TERM
                {
                    ...
                    CUP$Parser$result = parser.getSymbolFactory().newSymbol("EXP", 25,
                            ((java_cup.runtime.Symbol) CUP$Parser$stack.peek()),
                            ((java_cup.runtime.Symbol) CUP$Parser$stack.peek()), RESULT);
                }
                    return CUP$Parser$result;
                ...
                case 62: // ARIT_TERM ::= ARIT_FACTOR ARIT_TERM_REST
                {
                    ...
                    CUP$Parser$result = parser.getSymbolFactory().newSymbol("ARIT_TERM", 26,
                            ((java_cup.runtime.Symbol) CUP$Parser$stack.elementAt(CUP$Parser$top - 1)),
                            ((java_cup.runtime.Symbol) CUP$Parser$stack.peek()), RESULT);
                }
                    return CUP$Parser$result;
                ...
                case 63: // ARIT_TERM_REST ::= plus ARIT_FACTOR ARIT_TERM_REST
                {
                    ...
                    CUP$Parser$result = parser.getSymbolFactory().newSymbol("ARIT_TERM_REST", 28,
                            ((java_cup.runtime.Symbol) CUP$Parser$stack.elementAt(CUP$Parser$top - 2)),
                            ((java_cup.runtime.Symbol) CUP$Parser$stack.peek()), RESULT);
                }
                    return CUP$Parser$result;
                ...
                case 66: // ARIT_FACTOR ::= lparen EXP rparen
                {
                    ...
                    CUP$Parser$result = parser.getSymbolFactory().newSymbol("ARIT_FACTOR", 27,
                            ((java_cup.runtime.Symbol) CUP$Parser$stack.elementAt(CUP$Parser$top - 2)),
                            ((java_cup.runtime.Symbol) CUP$Parser$stack.peek()), RESULT);
                }
                    return CUP$Parser$result;
                ...
                case 68: // LOG_TERM ::= EXP equal EXP
                {
                    ...
                    CUP$Parser$result = parser.getSymbolFactory().newSymbol("LOG_TERM", 29,
                            ((java_cup.runtime.Symbol) CUP$Parser$stack.elementAt(CUP$Parser$top - 2)),
                            ((java_cup.runtime.Symbol) CUP$Parser$stack.peek()), RESULT);
                }
                    return CUP$Parser$result;
                ...
                case 72: // TUPLA_ACCESS ::= id lbracket index_literal rbracket
                {
                    ...
                    CUP$Parser$result = parser.getSymbolFactory().newSymbol("TUPLA_ACCESS", 30,
                            ((java_cup.runtime.Symbol) CUP$Parser$stack.elementAt(CUP$Parser$top - 3)),
                            ((java_cup.runtime.Symbol) CUP$Parser$stack.peek()), RESULT);
                }
                    return CUP$Parser$result;
                ...
                case 73: // LIT ::= NEG_ENT_LIT
                {
                    ...
                    CUP$Parser$result = parser.getSymbolFactory().newSymbol("LIT", 31,
                            ((java_cup.runtime.Symbol) CUP$Parser$stack.peek()),
                            ((java_cup.runtime.Symbol) CUP$Parser$stack.peek()), RESULT);
                }
                    return CUP$Parser$result;
                ...
                case 75: // POS_ENT_LIT ::= integer_literal
                {
                    ...
                    CUP$Parser$result = parser.getSymbolFactory().newSymbol("POS_ENT_LIT", 32,
                            ((java_cup.runtime.Symbol) CUP$Parser$stack.peek()),
                            ((java_cup.runtime.Symbol) CUP$Parser$stack.peek()), RESULT);
                }
                    return CUP$Parser$result;
                ...
                case 76: // NEG_ENT_LIT ::= minus integer_literal
                {
                    ...
                    CUP$Parser$result = parser.getSymbolFactory().newSymbol("NEG_ENT_LIT", 33,
                            ((java_cup.runtime.Symbol) CUP$Parser$stack.elementAt(CUP$Parser$top - 1)),
                            ((java_cup.runtime.Symbol) CUP$Parser$stack.peek()), RESULT);
                }
                    return CUP$Parser$result;
                ...
                case 77: // BOL_LIT ::= boolean_literal
                {
                    ...
                    CUP$Parser$result = parser.getSymbolFactory().newSymbol("BOL_LIT", 34,
                            ((java_cup.runtime.Symbol) CUP$Parser$stack.peek()),
                            ((java_cup.runtime.Symbol) CUP$Parser$stack.peek()), RESULT);
                }
                    return CUP$Parser$result;
